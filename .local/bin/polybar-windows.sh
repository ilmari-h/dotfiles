#!/bin/sh
# TODO: make a copy of this but instead use bspc to query windows
# Also issue with polybar interval updating only ever so often
# TODO: add icon option or something?
...
active_window_decoration_style_left_side="%{F#$color1}%{u#$color1}"
active_window_decoration_style_right_side="%{F-}"
